...
import xzydemo.demo.Server.SupportClass.Interface.SendMail;
...
public class SendMailImpl implements SendMail {
    ...
    /**
     *
     * @param MailAccount user mailAddress
     * @param VerificationCode mail VerificationCode
     * @return
     */
    public static boolean SendMail(String MailAccount,String VerificationCode) {
        ...
        props.put("mail.user", "admin@mail.xzyhyfw.com");
        // 访问SMTP服务时需要提供的密码(在控制台选择发信地址进行设置)
        props.put("mail.password", "asd123ASDqwe");
        ...
        try {
            ...
            InternetAddress from = new InternetAddress("admin@mail.xzyhyfw.com","心之缘");
            ...
            //}
            // 设置邮件标题
            message.setSubject("你的的验证码");
            // 设置邮件的内容体
            message.setContent("<div>你的验证码是<br/> <p style='font-size:28px;background-color:rgba(48,99,201,1.00)'>"+VerificationCode+"<p/></div>", "text/html;charset=UTF-8");
